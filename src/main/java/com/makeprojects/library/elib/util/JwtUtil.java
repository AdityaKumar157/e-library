package com.makeprojects.library.elib.util;
...
public class JwtUtil {
    ...
    public boolean validateToken(String token, @NotNull Member member) {
        final String username = this.extractUsername(token);
        return (username.equals(member.getUserName()) && !this.isTokenExpired(token));
    }
